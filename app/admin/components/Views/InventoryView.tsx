                                                    ...
                                                    <div className="flex items-center gap-1 bg-slate-50 dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-700">
                                                        ...
                                                        <div className="flex gap-1">
                                                            <button
                                                                ...
                                                                className="bg-white dark:bg-slate-800 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 transition-all shadow-sm"
                                                                title="Remove Stock"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="bg-teal-600 text-white hover:bg-teal-700 p-1.5 rounded-lg transition-all shadow-md shadow-teal-500/20"
                                                                title="Add Stock"
                                                            >
